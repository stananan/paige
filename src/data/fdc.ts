...
export const fdcMetrics: FdcMetric[] = [
  {
    ...
    value: "$89.2M",
    detail: "Q2 2026 forecast exit ARR",
    trend: "+29% YoY",
  },
  {
    label: "Q2 revenue",
    value: "$21.6M",
    detail: "Preliminary full-quarter forecast",
    trend: "+29% YoY",
  },
  {
    label: "Gross margin",
    value: "77%",
    detail: "Q2 2026 forecast",
    trend: "Above plan",
  },
  {
...
function quarterlyReport(input: FdcQuarterReportInput): FdcDocument {
  ...
  return {
    ...
    summary: `${input.status} scorecard, revenue quality, operating performance, customer metrics, risks, and outlook.`,
    pages: [
      {
        title: `${input.period} executive scorecard`,
        lines: [
          `REPORT STATUS: ${input.status}. Reporting cutoff: ${input.cutoff}.`,
          "All currency values are in USD millions unless otherwise stated.",
          "",
          "PERIOD | REVENUE | EXIT ARR | GROSS MARGIN | OPERATING INCOME",
          `${rowLabel} | ${input.revenue} | ${input.exitArr} | ${input.grossMargin} | ${input.operatingIncome}`,
          "",
      ...
      {
        title: `${input.period} revenue and customer detail`,
        lines: [
          `REPORT STATUS: ${input.status}.`,
          "All currency values are in USD millions unless otherwise stated.",
          "",
          "METRIC | VALUE",
          `Subscription revenue | ${input.subscriptionRevenue}`,
          `Professional services revenue | ${input.servicesRevenue}`,
          `New ARR signed | ${input.newArr}`,
          `Total bookings | ${input.bookings}`,
          `Expansion ARR | ${input.expansionArr}`,
      ...
      {
        title: `${input.period} operating performance`,
        lines: [
          `REPORT STATUS: ${input.status}.`,
          "All currency values are in USD millions unless otherwise stated.",
          "",
          "OPERATING EXPENSE | VALUE",
          `Research and development | ${input.researchDevelopment}`,
          `Sales and marketing | ${input.salesMarketing}`,
          ...
          `Support SLA attainment: ${input.sla}.`,
          `Quarter-end employee count: ${input.employees}. Quarter-end customer count: ${input.customers}.`,
        ],
      },
      {
        title: `${input.period} outlook, risks, and actions`,
        lines: [
          `REPORT STATUS: ${input.status}.`,
          "All currency values are in USD millions unless otherwise stated.",
          "",
          "FORWARD OUTLOOK",
          `Management's next-quarter revenue target is $${input.nextQuarterRevenue} million.`,
          `Management's next-quarter exit ARR target is $${input.nextQuarterArr} million.`,
          "Management plans to keep gross margin at or above 75%.",
          "Management plans to keep net revenue retention at or above 120%.",
          "",
          "PRIMARY RISKS",
          ...input.risks,
          "",
          "MANAGEMENT ACTIONS",
          "Review enterprise implementation capacity every two weeks.",
          "Track all yellow-account renewals in the executive operating review.",
          "Gate incremental AI features on measured gross-margin impact.",
          "Publish quarter-close source data and variance notes with the next report.",
        ],
      },
    ],
  };
...
const fdcQuarterlyReports: FdcDocument[] = [
  quarterlyReport({
    period: "Q1 2025",
    status: "Actual",
    updated: "Apr 18, 2025",
    cutoff: "March 31, 2025",
    revenue: "16.0",
    planRevenue: "15.4",
    exitArr: "64.5",
    grossMargin: "74%",
    ...
    expansionArr: "2.2",
    grossChurn: "0.8",
    researchDevelopment: "4.6",
    salesMarketing: "5.7",
    generalAdministrative: "3.1",
    cloudInfrastructure: "2.6",
    supportTickets: "780",
    csat: "92%",
    sla: "97.8%",
    nextQuarterRevenue: "16.5",
    nextQuarterArr: "69.0",
    highlights: [
      "RelayOS inventory automation reached 310 customers.",
      "Enterprise implementation time improved to 78 days from 86 days.",
      "North America produced 76% of quarterly revenue.",
    ],
    risks: [
      "Implementation staffing remained below the capacity required by the enterprise backlog.",
      "FieldSync mobile adoption was below target in the home-services segment.",
      "Cloud inference cost was 8% above plan.",
    ],
  }),
  quarterlyReport({
    period: "Q2 2025",
    ...
    expansionArr: "2.5",
    grossChurn: "0.9",
    researchDevelopment: "4.9",
    salesMarketing: "5.9",
    generalAdministrative: "3.2",
    cloudInfrastructure: "2.7",
    supportTickets: "805",
    csat: "93%",
    sla: "98.0%",
    nextQuarterRevenue: "17.0",
    nextQuarterArr: "73.0",
    highlights: [
      "LedgerLens spend controls became generally available on May 20.",
      "FDC crossed 400 active customers during June.",
      "Enterprise implementation time improved to 74 days.",
    ],
    risks: [
      "Two large retail deployments moved from June into July.",
      "EMEA sales hiring was three roles behind plan.",
      "Inventory connector support volume increased after the spring release.",
    ],
  }),
  quarterlyReport({
    period: "Q3 2025",
    ...
    grossMargin: "74%",
    operatingIncome: "1.3",
    operatingCashFlow: "1.8",
    nrr: "121%",
    customers: "414",
    employees: "271",
    subscriptionRevenue: "15.6",
    servicesRevenue: "1.6",
    newArr: "3.8",
    bookings: "5.9",
    newCustomers: "18",
    expansionArr: "2.6",
    grossChurn: "0.8",
    researchDevelopment: "5.1",
    salesMarketing: "6.0",
    generalAdministrative: "3.3",
    cloudInfrastructure: "2.8",
    supportTickets: "842",
    csat: "93%",
    sla: "98.2%",
    nextQuarterRevenue: "18.1",
    nextQuarterArr: "76.0",
    highlights: [
      "FieldSync route coordination launched to all enterprise customers.",
      "Expansion from Lighthouse Grocers added $0.8 million of ARR.",
      "Enterprise implementation time improved to 69 days.",
    ],
    risks: [
      "FieldSync offline workflows remained behind the original delivery schedule.",
      "A warehouse schema migration increased analytics support tickets.",
      "Two Q4 renewals required executive sponsorship.",
    ],
  }),
  quarterlyReport({
    period: "Q4 2025",
    ...
    grossMargin: "75%",
    operatingIncome: "1.5",
    operatingCashFlow: "2.1",
    nrr: "121%",
    customers: "421",
    employees: "278",
    subscriptionRevenue: "16.7",
    servicesRevenue: "1.7",
    newArr: "3.3",
    bookings: "5.4",
    newCustomers: "14",
    expansionArr: "2.9",
    grossChurn: "0.7",
    researchDevelopment: "5.3",
    salesMarketing: "6.4",
    generalAdministrative: "3.5",
    cloudInfrastructure: "2.9",
    supportTickets: "870",
    csat: "94%",
    sla: "98.4%",
    nextQuarterRevenue: "19.2",
    nextQuarterArr: "82.0",
    highlights: [
      "FDC delivered its first profitable full fiscal year.",
      "Gross margin reached 75% after cloud workload optimization.",
      "FieldSync weekly active usage reached 62%.",
    ],
    risks: [
      "The EMEA leadership role remained open at year end.",
      "Northstar Logistics entered 2026 without a confirmed executive sponsor.",
      "EU data residency work required additional security engineering capacity.",
    ],
  }),
  quarterlyReport({
    period: "Q1 2026",
    status: "Actual",
    updated: "Apr 24, 2026",
    cutoff: "March 31, 2026",
    revenue: "19.8",
    planRevenue: "19.2",
    exitArr: "82.6",
    grossMargin: "76%",
    operatingIncome: "1.9",
    operatingCashFlow: "2.6",
    nrr: "123%",
    customers: "428",
    employees: "286",
    subscriptionRevenue: "18.1",
    servicesRevenue: "1.7",
    newArr: "6.4",
    bookings: "8.7",
    newCustomers: "20",
    expansionArr: "3.2",
    grossChurn: "0.8",
    researchDevelopment: "5.6",
    salesMarketing: "6.8",
    generalAdministrative: "3.7",
    cloudInfrastructure: "3.0",
    supportTickets: "932",
    csat: "94%",
    sla: "98.6%",
    nextQuarterRevenue: "21.0",
    nextQuarterArr: "88.0",
    highlights: [
      "Enterprise net revenue retention reached 129%.",
      "Median enterprise implementation time improved to 63 days.",
      "RelayOS and LedgerLens availability both exceeded 99.95%.",
    ],
    risks: [
      "Northstar Logistics usage fell after its executive sponsor departed.",
      "EMEA hiring speed remained below the board plan.",
      "AI inference spend was 11% above plan.",
    ],
  }),
  quarterlyReport({
    period: "Q2 2026",
    status: "Preliminary forecast",
    updated: "Jun 5, 2026",
    cutoff: "May 31, 2026; full-quarter forecast",
    revenue: "21.6",
    planRevenue: "21.0",
    exitArr: "89.2",
    grossMargin: "77%",
    operatingIncome: "2.7",
    operatingCashFlow: "3.1",
    nrr: "124%",
    customers: "447",
    employees: "298",
    subscriptionRevenue: "19.9",
    servicesRevenue: "1.7",
    newArr: "6.6",
    bookings: "9.4",
    newCustomers: "25",
    expansionArr: "3.8",
    grossChurn: "0.7",
    researchDevelopment: "5.9",
    salesMarketing: "7.2",
    generalAdministrative: "3.8",
    cloudInfrastructure: "3.1",
    supportTickets: "980",
    csat: "95%",
    sla: "98.8%",
    nextQuarterRevenue: "22.8",
    nextQuarterArr: "95.0",
    highlights: [
      "The forecast includes signed contracts through May 31 and the June commit pipeline.",
      "LedgerLens expansion is the largest source of forecast ARR growth.",
      "Enterprise implementation time is forecast to improve to 57 days.",
    ],
    risks: [
