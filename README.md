...
- [ ] **6–9 Ingest pipeline** — `bun run ingest`: /data → Unsiloed parse (keep pages) → chunk → Moss index
- [ ] **9–13 Fast beat (hero)** — wake cmd → Moss retrieve → LLM (TrueFoundry) → spoken answer + cited card + chart
